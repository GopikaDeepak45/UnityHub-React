...
// //           <span>{post.userId.username}</span> - <span>{new Date(post.createdAt).toLocaleString()}</span>
// //         </div>
// //         <div className="post-content">{post.content}</div>
// //         <div className="post-media">
// //           {post.media.map((mediaItem) => (
// //             <div key={mediaItem.data.publicId} className="media-item">
// //               {mediaItem.type === 'image' ? (
// //                 <img src={mediaItem.data.url} alt="Post media" />
// //               ) : (
// //                 <video controls>
...
// //           <LikeButton postId={post._id} likes={post.likes.length} />
...
// const PostItem: React.FC<PostItemProps> = ({ post }) => {
//   return (
//     <div className="max-w-lg mx-auto my-4 bg-white rounded-lg shadow-lg transition-transform duration-500 hover:scale-105 hover:shadow-2xl">
//       <div className="p-4">
//         <div className="flex items-center mb-4">
//           <img className="w-12 h-12 rounded-full" src="https://d2qp0siotla746.cloudfront.net/img/use-cases/profile-picture/template_3.jpg" alt="User profile" />
//           <div className="ml-4">
//             <h2 className="text-lg font-semibold text-gray-800">{post.userId.username}</h2>
...
import CommentSectionGroups from './CommentSectionGroups';
...
const PostItemGroups: React.FC<PostItemProps> = ({ post }) => {
    ...
    <div className="max-w-2xl mx-auto my-6 bg-white rounded-lg shadow-lg transition-transform duration-500 hover:scale-100 hover:shadow-2xl ">
      <div className="p-4">
        ...
        <div className="flex justify-between px-5 items-center">
          <LikeButtonGroup postId={post._id} likes={post.likes.length} likesArray={post.likes}  />
          {/* <CommentSection comments={post.comments} postId={post._id} /> */}
          <div >
            <MessageCircleMore
        ...
        {showComments && <CommentSectionGroups  postId={post._id} groupId={post.groupId}/>}
