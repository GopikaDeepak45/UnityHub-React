...
import { useLikeCommentMutation,  useUnlikeCommentMutation,  } from '@/redux/apiSlices/postApiSlice';
...
const CommentLikeButton: React.FC<LikeButtonProps> = ({ commentId, likes,likesArray  }) => {
